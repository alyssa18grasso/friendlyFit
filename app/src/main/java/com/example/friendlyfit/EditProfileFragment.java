...
public class EditProfileFragment extends Fragment {
    ...
    private ImageButton imageButton_BackToProfile;
    ...
    public EditProfileFragment(User userInfo) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageButton_BackToProfile = rootView.findViewById(R.id.imageButton_BackToProfile);
        imageView_EditProfile = rootView.findViewById(R.id.imageView_EditProfile);
        editText_ProfileName = rootView.findViewById(R.id.editText_ProfileName);
        editText_FavWorkout = rootView.findViewById(R.id.editText_FavWorkout);
        editText_GoalNumber = rootView.findViewById(R.id.editText_GoalNumber);
        spinner_Numerator = rootView.findViewById(R.id.spinner_Numerator);
        spinner_Denominator = rootView.findViewById(R.id.spinner_Denominator);
        editText_Bio = rootView.findViewById(R.id.editText_Bio);
        button_saveProfile = rootView.findViewById(R.id.button_saveProfile);
        ...
        if (userInfo.getProfilePictureUri() != null) {
            ...
            profilePictureUri = userInfo.getProfilePictureUri();
        }


        imageButton_BackToProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendData.backToUserProfile();
            }
        });
        ...
        imageView_EditProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendData.startCamera(userInfo, "edit");
            }
        });
